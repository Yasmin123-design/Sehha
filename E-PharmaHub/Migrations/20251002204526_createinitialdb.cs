        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiredType = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DonorProfiles_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MessageThreads_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AlternativeMedications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AlternativeMedications_Medications_AlternativeId",
                        column: x => x.AlternativeId,
                        principalTable: "Medications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AlternativeMedications_Medications_MedicationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatMessages_MessageThreads_ThreadId",
                        column: x => x.ThreadId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MessageThreadParticipant_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MessageThreadParticipant_MessageThreads_ThreadId",
                        column: x => x.ThreadId,
                        principalTable: "MessageThreads",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlternativeMedications_AlternativeId",
                table: "AlternativeMedications",
                column: "AlternativeId");

            migrationBuilder.CreateIndex(
                name: "IX_AlternativeMedications_MedicationId",
                table: "AlternativeMedications",
                column: "MedicationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Medications_GenericName_Strength",
                table: "Medications",
                columns: new[] { "GenericName", "Strength" });

            migrationBuilder.CreateIndex(
                name: "IX_MessageThreadParticipant_ThreadId_UserId",
                table: "MessageThreadParticipant",
                columns: new[] { "ThreadId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MessageThreadParticipant_UserId",
                table: "MessageThreadParticipant",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_MessageThreads_AppUserId",
